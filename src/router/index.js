...
const shopRoutes = [
  { name: 'news_1', component: Newcard_01, shop: 'Tree&Co' },
  { name: 'news_2', component: Newcard_02, shop: 'Kanom mae' },
  { name: 'news_3', component: Newcard_03, shop: 'Soul Cafe mju'},
  { name: 'news_4', component: Newcard_04, shop: 'Fong nom'},
];
